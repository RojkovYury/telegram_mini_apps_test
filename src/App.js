  ...
  return (
    <div className="App">
        <Box sx={{ display: 'flex', flexDirection: 'column', px:3, pt: 5 }}>
          ...
          <div style={{ width: '100%', paddingBottom: '16px', marginBottom: '2px' }}>
            <label style={{ paddingLeft: '10px' }}>Card Number</label>
            <div style={{ border: '2px solid black', borderRadius: '4px', display: 'flex' }}>
              ...
              <input style={{ width: '100%', paddingTop: '10px', paddingBottom: '10px', paddingRight: '10px', border: 'none', outline: 'none', fontSize: '18px' }}/>
            </div>
